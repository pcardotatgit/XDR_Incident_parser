...
<html>
<head>
    <title>Visual Incident Tree View</title>
    <link rel="StyleSheet" href="dtree.css" type="text/css" />
    <script type="text/javascript" src="dtree.js"></script>
</head>
<body>
<h1>Visual Incident Tree View with key Python paths</h1>
<div class="dtree">
            ...
            if event not in word_list:
                ...
                if type(value) is str:
                    ...
                    if len(value)<1000 and value.count('\n')==0 and value.count('\r')==0:
                        ...
                        note_name='./dtree/note_'+str(notes_index)+'.txt'
                        notes_index+=1
                ...
                if valeur=="member-of" or valeur=="sighting-of":
                    description='<span style="color:green;font-weight:bolder">{}</span> = <span style="color:red;font-weight:bolder">{}</span>  |---------------> {} '.format( key, valeur, prefix2) 
                else:
...
if __name__=="__main__":
    files =[file for file in os.listdir('./incident_summary')]
    for file in files:
        fichier='./incident_summary/'+file
    #print(fichier) 
    ...
    with open('./dtree/index.html','w') as fich:
        fich.write(text_out)
    print('DONE')
